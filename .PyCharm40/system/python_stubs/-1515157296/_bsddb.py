# encoding: utf-8
# module _bsddb
# from /usr/lib/python2.7/lib-dynload/_bsddb.so
# by generator 1.136
# no doc
# no imports
...
DB_NOSERVER_HOME = -30989
DB_NOSERVER_ID = -30988

DB_NOSYNC = 1
DB_NOTFOUND = -30987
DB_ODDFILESIZE = 128

DB_OLD_VERSION = -30986
...
DB_REP_CONF_BULK = 8
DB_REP_CONF_DELAYCLIENT = 16
DB_REP_CONF_INMEM = 32
DB_REP_CONF_LEASE = 64
DB_REP_CONF_NOWAIT = 128

DB_REP_CONNECTION_RETRY = 3

DB_REP_DUPMASTER = -30984
DB_REP_ELECTION = 4
...
DB_REP_HOLDELECTION = -30982
DB_REP_IGNORE = -30981
DB_REP_ISPERM = -30980

DB_REP_JOIN_FAILURE = -30979

DB_REP_LEASE_EXPIRED = -30978
DB_REP_LEASE_TIMEOUT = 9

DB_REP_MASTER = 2
DB_REP_NEWSITE = -30976
DB_REP_NOBUFFER = 2
DB_REP_NOTPERM = -30975
DB_REP_PERMANENT = 4
DB_REP_REREQUEST = 8
...
DB_STAT_LOCK_CONF = 8
DB_STAT_LOCK_LOCKERS = 16
DB_STAT_LOCK_OBJECTS = 32
DB_STAT_LOCK_PARAMS = 64

DB_STAT_MEMP_HASH = 8

DB_STAT_SUBSYSTEM = 2

DB_SYSTEM_MEM = 131072
...
DB_VERB_REP_SYSTEM = 8192

DB_VERB_WAITSFOR = 32768
