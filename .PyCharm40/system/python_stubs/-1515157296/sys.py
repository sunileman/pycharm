...
executable = '/root/untitled/bin/python'

exec_prefix = '/root/untitled'
...
version = '2.7.3 (default, Mar 13 2014, 11:03:55) \n[GCC 4.7.2]'
...
path = [
    '/etc/pycharm/helpers',
    '/root/untitled/lib/python2.7',
    '/root/untitled/lib/python2.7/plat-linux2',
    '/root/untitled/lib/python2.7/lib-tk',
    '/root/untitled/lib/python2.7/lib-old',
    '/root/untitled/lib/python2.7/lib-dynload',
    '/usr/lib/python2.7',
    '/usr/lib/python2.7/plat-linux2',
    '/usr/lib/python2.7/lib-tk',
    '/root/untitled/local/lib/python2.7/site-packages',
    '/root/untitled/lib/python2.7/site-packages',
]
